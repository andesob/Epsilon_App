...
public class CalendarRecyclerViewAdapter extends RecyclerView.Adapter<CalendarRecyclerViewAdapter.ViewHolder> {
     ...
     *
     * @param context
     * @param calendarList the input list to be displayed
     */
    ...
    /**
     * Sets the information to be shown to the user
     *
     * @param holder
     * @param position
     */
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.deleteButton.setOnClickListener(new View.OnClickListener() {
            /**
             * Deletes calendar item if user is board member or admin
             * @param v
             */
            @Override
        ...
        holder.addButton.setOnClickListener(new View.OnClickListener() {
            /**
             * Adds the calendar event to your phones calendar
             * @param v
             */
            @Override
            public void onClick(View v) {
    ...
    /**
     * Gets the day name of the set date
     *
     * @param startYear
     * @param startMonth
     * @param startDay
    ...
    /**
     * Method to add a calendar item to your phone calendar
     *
     * @param calendar event you want to add
     */
    private void addCalendarToPhone(Calendar calendar) {
        long calId = 1;
        long startMillis = 0;
        long endMillis = 0;
        ...
        Toast.makeText(context, "Arrangement lagret i din kalender", Toast.LENGTH_SHORT).show();
    }
